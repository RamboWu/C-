#ifndef LINE_SIMILAR_H
#define LINE_SIMILAR_H
...
class SimilarCompare {
public:
	bool operator() (const SimilarMeta &a, const SimilarMeta &b) {
...
public:
	...
	LineSimilar(LineReport* line_report) {
		this->line_report = line_report;
	}
